...
_G.packer_plugins = {
  ...
  ["cmp-cmdline"] = {
    loaded = true,
    path = "/home/noemi/.local/share/nvim/site/pack/packer/start/cmp-cmdline",
  ...
  colorschemes = {
    loaded = true,
    path = "/home/noemi/.local/share/nvim/site/pack/packer/start/colorschemes",
  ...
  ["nvim-lsp-installer"] = {
    loaded = true,
    path = "/home/noemi/.local/share/nvim/site/pack/packer/start/nvim-lsp-installer",
  ...
  ["popup.nvim"] = {
    loaded = true,
    path = "/home/noemi/.local/share/nvim/site/pack/packer/start/popup.nvim",
    url = "https://github.com/nvim-lua/popup.nvim"
  },
  ["telescope-media-files.nvim"] = {
    loaded = true,
    path = "/home/noemi/.local/share/nvim/site/pack/packer/start/telescope-media-files.nvim",
